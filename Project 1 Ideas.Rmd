...
#####################################################
####### Sollten wir hier beim AR(1) nicht die First differences verwenden. Weil wir ja einen I(1) prozess haben. Und sollten wir nicht zuerst die ARMA Model selection machen und dann vergleichen ? #####
#####################################################
