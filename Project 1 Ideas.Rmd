...
Sollten wir hier nicht mit MA(1) weiterarbeiten? Ich habs mal weiter unten mit MA(1) gemacht. Den AR(1) part aber noch nicht gelöscht ####LÖSCHEN####
  
# Differenced AR(1) and ARCH Model for Gold Prices ####LÖSCHEN####
